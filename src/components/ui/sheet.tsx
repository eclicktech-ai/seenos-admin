...
const sheetVariants = cva(
  "fixed z-50 gap-4 border border-border shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
function SheetHeader({
  ...
  return (
    <div
      className={cn(
        "flex flex-col space-y-2 text-center sm:text-left p-4 border-b border-border",
        className
      )}
      {...props}
    />
